...
import type { PropertyListingMode } from "./listing-mode";

export type { PropertyListingMode };

type PropertyListingWizardProps = {
...
const adminPropertySchema = propertySchema.extend({
...
const steps = [
  ...
  { id: 4, title: "Amenities & nearby", description: "Amenities and what's nearby" },
...
export function PropertyListingWizard({
  ...
  const {
    ...
    resolver: zodResolver(
      isAdminMode ? adminPropertySchema : propertySchema
    ) as Resolver<PropertyForm>,
    mode: "onChange",
    defaultValues: {
  ...
  const validateCurrentStep = async (): Promise<boolean> => {
    ...
    switch (currentStep) {
      ...
      case 2:
        ...
        if (isAdminMode) {
          fieldsToValidate.push("owner_name", "owner_phone");
        }
        break;
      case 3:
  ...
  const nextStep = async () => {
    ...
    if (currentStep === 1) {
      ...
      if (selectedType === "pg") {
        router.push(
          isAdminMode
            ? "/admin/properties/new/pg"
            : "/dashboard/properties/new/pg"
        );
        return;
      }
    }
  ...
  const onSubmit: SubmitHandler<PropertyForm> = async (data) => {
    ...
    try {
      ...
      toast.success(
        isAdminMode
          ? "Property added successfully and is now live."
          : "Property listed successfully! It will be reviewed by admin before going live."
      );
      router.push(isAdminMode ? "/admin/properties" : "/dashboard/properties");
    } catch (error: unknown) {
  ...
  return (
    <div className={isAdminMode ? "" : "min-h-screen bg-background"}>
      {!isAdminMode && <Navbar />}

      <div className={isAdminMode ? "" : "pt-20"}>
        <div
          className={
            isAdminMode
              ? "max-w-4xl mx-auto"
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">
              {isAdminMode ? "Add Property" : "List Your Property"}
            </h1>
            <p className="text-muted-foreground">
              {isAdminMode
                ? "Create a listing on behalf of an owner. Include their name and phone number."
            ...
            <AnimatePresence mode="wait">
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  {isAdminMode && (
                    <div className="grid sm:grid-cols-2 gap-4 p-4 rounded-xl border border-primary/20 bg-primary/5">
                      <div>
              ...
              {currentStep === 4 && (
                ...
                >
                  ...
                  <div className="pt-2 border-t border-border">
                    <Label className="text-base mb-4 block">
                      <MapPinned className="w-4 h-4 inline mr-2 align-[-0.125em]" />
                      Nearby (optional)
                    </Label>
                    <p className="text-sm text-muted-foreground mb-4">
                      Type a place or landmark (e.g. metro, railway station),
                      then click Add. Add as many as you like.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
                      <Input
                        ...
                        placeholder="e.g. Metro station, school, mall…"
              ...
              {currentStep === 5 && (
                ...
                >
                  ...
                  <div className="p-4 rounded-xl bg-primary/5 border border-primary/20">
                    <p className="text-sm">
                      {isAdminMode
                        ? "By submitting, you confirm the listing details and owner contact information are accurate. The property will go live immediately."
                        : "By submitting, you agree to our terms and confirm that the information provided is accurate. Your listing will be reviewed before going live."}
                    </p>
                  </div>
                </motion.div>
              )}
